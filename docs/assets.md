...
## Steve Rossiter hero portrait

`public/images/steve-rossiter-hero.png` is the current landing-page hero. Generated with the built-in ImageGen tool on September 7, 2026, using the four Steve Rossiter screenshots provided by the user as identity references. The close-up portrait was the primary facial reference. This is an AI-generated likeness, not an actual photograph of Steve in this gym. The original source screenshots remain outside the public website. No fallback CLI was used.
...
> Use case: photorealistic-natural. Asset type: hero photograph for Meridian, a restrained premium strength and nutrition coaching website with an off-white and navy visual identity. Create a vertical 4:5 editorial photograph of an approachable strength coach in a plain navy shirt observing an adult woman client preparing a barbell deadlift in a real boutique strength gym. Candid between-set moment, natural bodies, not bodybuilding advertising. Full or three-quarter figures in the middle distance with black weight plates and steel rack in foreground, warm concrete walls, large industrial windows and soft daylight. Rich charcoal and muted warm gray palette, subtle film texture, documentary fitness magazine photography. Plenty of environmental context, beautifully composed, realistic anatomy and equipment. No text, no brand logos, no watermarks.

The image is illustrative and does not depict a verified coach or client. No fallback CLI was used.
